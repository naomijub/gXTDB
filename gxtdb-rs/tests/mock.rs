use gxtdb_rs::api::grpc_api_server::{GrpcApiServer, GrpcApi};
use gxtdb_rs::api;
...
impl GrpcApi for ServerMock {
    async fn status(&self, _request: tonic::Request<api::Empty>) -> Result<tonic::Response<api::StatusResponse>, tonic::Status>{
